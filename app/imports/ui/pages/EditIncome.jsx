...
const bridge = new SimpleSchema2Bridge(Incomes.schema);
...
class EditIncome extends React.Component {
  ...
  submit(data) {
    ...
    Incomes.collection.update(_id, { $set: { name, amount } }, (error) => (error ?
  ...
  renderPage() {
    return (
        <Grid container centered>
          <Grid.Column>
            <Header as="h2" textAlign="center">Edit Income Item</Header>
...
/** Require the presence of an Income document in the props object. Uniforms adds 'model' to the props, which we use. */
...
export default withTracker(({ match }) => {
  ...
  return {
    doc: Incomes.collection.findOne(documentId),
